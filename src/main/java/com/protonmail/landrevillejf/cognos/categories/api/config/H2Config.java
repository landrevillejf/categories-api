...
@Profile("test")
@Configuration
@EnableJpaRepositories(basePackages = {"com.protonmail.landrevillejf.cognos.categories.api.repository"})
...
public class H2Config {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.protonmail.landrevillejf.cognos.categories.api.entity.model");
